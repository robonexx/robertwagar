...
export default function Theme({lights, lightsOnOff}) {
    ...
    <line x1="291.642" y1="168.226" x2="291.642" y2="0.11322" stroke="black" strokeWidth="6"/>
    <defs>
    ...
    <stop offset="0.947917" />
        ...
        <svg onClick={lightsOnOff} className='light' fill={!lights ? '#e9c915' : '#121212'} xmlns="http://www.w3.org/2000/svg">
